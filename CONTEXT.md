...
│   ├── ForecastTab.tsx       — תחזית כ"א 12 שבועות + סימולטור גיוס
...
- **גרף 5 קווים** (Chart.js): צפי כולל / נדרש 100% / יעד 125% / צפי שישי / נדרש שישי (שני צירי Y)
- **לוח ימים מיוחדים** — טבלה כרונולוגית של כל החגים 12 חודשים קדימה, מסבירה את הלוגיקה מאחורי "רצוי" (read-only)
...
- **פיצ'ר "איזו עובדת כדאי לגייס"** — ניתוח חוסרים לפי יום×משמרת, פרופיל מומלץ (היקף/סוג/שישי/ימים), טקסט משרה מוכן להעתקה, ייצוא PDF, התראות על עובדות עוזבות

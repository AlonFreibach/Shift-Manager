...
> **תכונות רוחב (כל הלשוניות):** כפתור **↩ בטל** (גם Ctrl+Z) לביטול הפעולה האחרונה,
> כפתור **?** בהדר לפתיחת מדריך מהיר, ו-Error Boundary גלובלי למניעת קריסה מלאה.
...
### סטטוס
✅ הועלה לפרודקשן ואומת חי (commit `2940852`) — נבדק מול ה-CSS המוגש מהאתר החי.
